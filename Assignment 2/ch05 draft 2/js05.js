...
function createLightbox() {
   ...
   function createOverlay() {
      ...
      // Add fav Button to the overlay
      let overlayAddFav = document.createElement("a");
      overlayAddFav.href = "#";
      overlayAddFav.innerHTML = "Add to favorites";
      favLink.classList.add("add-favorite");
      //overlayAddFav.appendChild(overlayAddFav);
   ...
   function addToFavorites(image) {
      ...
      let favoriteImages = favoritesContainer.querySelectorAll('img');
      if (favoriteImages.length >= 5) {
          alert('You can add up to 5 images to favorites');
          return;
      }
      ...
      removeLink.addEventListener('click', function(event) {
          ...
          favoritesContainer.removeChild(image);
      });
